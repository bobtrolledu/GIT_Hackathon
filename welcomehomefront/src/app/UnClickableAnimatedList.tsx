...
const UnClickableAnimatedList: React.FC<AnimatedListProps> = ({
  items = [],
  onItemSelect,
  showGradients = true,
    ...
    <div className={`relative w-full ${className}`}>
      ...
      >
        {items.map((item, index) => (
          ...
          >
            <div
              className={`p-4 bg-background pointer-events-none rounded-lg hover:bg-background ${selectedIndex === index ? "bg-background" : "" }' ${itemClassName}`}
            >
...
export default UnClickableAnimatedList;